    ...
    async def test_list_files(self):
        ...
        with patch('app.services.storage_service.boto3') as mock_boto:
            ...
            mock_s3.list_objects_v2.return_value = {
                "Contents": [
                    {"Key": "uploads/user1/file1.jpg", "Size": 1024, "LastModified": "2024-01-01"},
                    {"Key": "uploads/user2/file2.png", "Size": 2048, "LastModified": "2024-01-02"},
                ]
            }
...
class TestSessionService:
    ...
    async def test_get_session(self):
        ...
        mock_cache_get = AsyncMock(return_value={
            "user_id": "user123",
