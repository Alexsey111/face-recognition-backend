...
class TestLivenessIntegration:
    ...
    def test_liveness_with_depth_analysis(self, client, test_user_token, face_image_base64):
...
class TestCacheIntegration:
    ...
    def test_verification_result_cached(self, client, test_user_token, face_image_base64):
