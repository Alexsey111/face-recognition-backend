...
class TestPhase1Infrastructure:
    ...
    def test_docker_compose_health_checks(self, project_root):
        ...
        for service_name in ["postgres", "redis", "minio"]:
            ...
            assert service_config is not None, f"Сервис {service_name} должен существовать"
    ...
    def test_verification_sessions_table_creation(self, project_root):
        ...
        assert "verification" in content.lower() or "session" in content.lower(), \
    ...
    def test_foreign_key_constraints(self, project_root):
        ...
        assert "foreign" in content_lower or "fk" in content_lower, \
    ...
    def test_unique_constraints(self, project_root):
        ...
        assert "unique" in content_lower or "index" in content_lower, \
    ...
    def test_indexes_creation(self, project_root):
        ...
        assert "index" in content_lower or "create_index" in content_lower or "PrimaryKeyIndex" in content_lower, \
    ...
    def test_redis_config_exists(self, project_root):
        ...
        assert "REDIS_CONNECTION_POOL_SIZE" in content, \
    ...
    def test_redis_service_configuration(self, project_root):
        ...
        if compose_path.exists():
            ...
            assert redis_service is not None, "Redis сервис должен быть настроен в docker-compose.yml"
    ...
    def test_storage_service_exists(self, project_root):
        ...
        assert "S3" in content or "s3" in content.lower(), "StorageService должен работать с S3"
    ...
    def test_minio_setup_script_exists(self, project_root):
        ...
        if not setup_script_path.exists():
            ...
            content_lower = content.lower()
            assert "minio" in content_lower or "s3" in content_lower, \
    ...
    def test_minio_service_configuration(self, project_root):
        ...
        if compose_path.exists():
            ...
            assert minio_service is not None, "MinIO сервис должен быть настроен в docker-compose.yml"
    ...
    def test_database_config(self, project_root):
        ...
        assert "DATABASE_POOL_SIZE" in content, "Должна быть DATABASE_POOL_SIZE конфигурация"
    ...
    def test_config_validation(self, project_root):
        ...
        assert "validator" in content_lower or "field_validator" in content_lower, \
    ...
    def test_dev_dependencies(self, project_root):
        ...
        assert "black" in content or "flake8" in content or "mypy" in content, \
        ...
        if has_pyproject:
            try:
                with open(pyproject_path, 'r', encoding='utf-8') as f:
                    content = f.read()
                assert "pytest" in content.lower() or "tool.pytest" in content.lower() or "testpaths" in content.lower(), \
