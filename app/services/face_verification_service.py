...
class FaceVerificationService:
    ...
    def __init__(
        ...
        security_level: Literal[
            "high_security", "balanced", "high_recall"
        ] = "balanced",
    ...
    async def _load_model(self) -> None:
        ...
        if self.model_type == "facenet":
            ...
            try:
                from torchvision.models import ResNet100_Weights, resnet100
    ...
    async def verify_face(
        ...
        try:
            ...
            accuracy_metrics = self._compute_accuracy_metrics(cosine_sim, threshold)
    ...
    def _compute_accuracy_metrics(
        ...
        accuracy_estimate = (tar_estimate * (1 - far_estimate)) + (
            far_estimate * frr_estimate
        )
