...
class GlobalExceptionHandler:
    ...
    async def handle_validation_error(
        ...
        return JSONResponse(
            status_code=400, content=response, headers={"X-Error-ID": error_id}
        )
    ...
    async def handle_not_found_error(
        ...
        return JSONResponse(
            status_code=404, content=response, headers={"X-Error-ID": error_id}
        )
    ...
    async def handle_unauthorized_error(
        ...
        return JSONResponse(
            status_code=401, content=response, headers={"X-Error-ID": error_id}
        )
